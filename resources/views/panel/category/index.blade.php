    ...
    <div class="content-header">
        <div class="container-fluid px-4">
            <div class="row mb-2 d-flex flex-wrap justify-content-between">
                ...
                <div>
                    @can('create_category')
                    <a href="{{route('admin.category.create')}}" class="btn btn-sm btn-outline-primary p-2">افزودن دسته جدید</a>
                    @endcan
    ...
    <div class="content">
        <div class="container-fluid">
           <div class="card shadow-sm">
               ...
               <a href="{{route('admin.category.index')}}?delete=1" class="btn btn-outline-yellow">دسته های حذف شده</a>
               <a href="{{route('admin.category.index')}}" class="btn btn-outline-blue mr-2">نمایش دسته ها</a>
           </div>
               <div class="py-4 px-4 ">

                    @include('panel.category.categories-group', ['categories' => $categories])
